...
# **********
# BUILD ITERABLES FROM YOUR DATA
# **********
...
# ***************************
# Define the optimizer and learning rate policy
...
with closing(ngt.make_transformer()) as transformer:
    ...
    # Continue generating for no_gen_time_points
    no_gen_time_points = 8 * no_points
    input_batch = np.zeros((batch_size, seq_len, feature_dim))
    input_batch[0] = data.train['X']['data'][0]
    gen_series = data.train['X']['data'][0]  # This is the generated series
