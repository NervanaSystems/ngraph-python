...
class Inceptionv3_b5(Sequential):
    ...
    def __call__(self, in_obj):
        ...
        branch_2_output = ng.concat_along_axis(
            branch_2_outputs, branch_1_output.axes.channel_axis())
        ...
        branch_3_output = ng.concat_along_axis(
            branch_3_outputs, branch_1_output.axes.channel_axis())
