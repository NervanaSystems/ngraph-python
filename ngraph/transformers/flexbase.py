...
class Flex(object):
    ...
    def __init__(self, storage_bits):
        ...
        self.type = 'flex'  # needed by conv
        self.itemsize = storage_bits / 8

        # TODO: keep this here? or gpu-specific?
        # quick fixes to get CONV working
        self.str = "<i2"

    # TODO: review eq    
    # TODO: should first set of type be isinstance?
...
class FlexEntry(object):
    ...
    def __init__(self, _id, init_dec, dtype):  # TODO: func signature for this and child class

        self._id = _id
        self.dtype = dtype
        # initial dec is flex type dependent and an autoflex parameter
        # dynamically adjusted dec
        self.scale = 1.0 / 2**init_dec  # ** algorithm works on scale, not dec
    ...
    def manage_before_computation(self, *args, **kwargs):
        print "flex_entry manage_before_computation"
        pass
