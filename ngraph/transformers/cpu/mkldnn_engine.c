...
mkldnn_primitive_desc_t create_mkldnn_layout_descriptor(
    mkldnn_engine_t engine, int ndims, const int* dim_sizes,
    const int* dim_strides, mkldnn_data_type_t data_type,
