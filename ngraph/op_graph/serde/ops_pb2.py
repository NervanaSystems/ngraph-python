...
_TENSOR = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='double_data', full_name='Tensor.double_data', index=4,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='uint_data', full_name='Tensor.uint_data', index=5,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='int_data', full_name='Tensor.int_data', index=6,
...
_AXISROLE = _descriptor.Descriptor(
  name='AxisRole',
  full_name='AxisRole',
  filename=None,
  file=DESCRIPTOR,
  ...
  fields=[
    _descriptor.FieldDescriptor(
      name='uuid', full_name='AxisRole.uuid', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='name', full_name='AxisRole.name', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=_b("").decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='docstring', full_name='AxisRole.docstring', index=2,
...
_AXIS = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='roles', full_name='Axis.roles', index=6,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='docstring', full_name='Axis.docstring', index=7,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='flattened_axes', full_name='Axis.flattened_axes', index=8,
      number=9, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_AXISROLE.fields_by_name['uuid'].message_type = _UUID
_AXIS.fields_by_name['uuid'].message_type = _UUID
_AXIS.fields_by_name['roles'].message_type = _AXISROLE
...
DESCRIPTOR.message_types_by_name['AxisRole'] = _AXISROLE
...
AxisRole = _reflection.GeneratedProtocolMessageType('AxisRole', (_message.Message,), dict(
  DESCRIPTOR = _AXISROLE,
  __module__ = 'ops_pb2'
  # @@protoc_insertion_point(class_scope:AxisRole)
  ))
_sym_db.RegisterMessage(AxisRole)
