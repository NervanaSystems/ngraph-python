...
test_data_single_operand = (
    ...
    (ng.safelog, [(MAXIMUM_FLEX_VALUE + 1, 10.39697265625, "The same result")],
     "Safe-Logarithm of a value greater than positive border value to achieve overflow"),

    # test_tanh
    (ng.tanh, [(MINIMUM_FLEX_VALUE - 1, np.tanh(MINIMUM_FLEX_VALUE), "The same result")],
