...
def generate_ds2_data(max_length, str_w, nbands, nout, batch_size, num_iter):
    ...
    train_set, eval_set = make_fake_dataloader(nbands, max_lbl_len,
                                               int(max_length / frame_stride),
...
def make_fake_dataloader(nbands, max_lbl_len, max_utt_len, nout, batch_size, num_iter,
    ...
    train_set = FakeDataIterator(dataset_info, batch_size, num_iter, same=same)
    eval_set = FakeDataIterator(dataset_info, batch_size, 10, same=same)
