...
class Tester(ImporterTester):
    ...
    def test_reshape(self):
        ...
        x = tf.constant(np.random.randn(3, 4, 5, 6).astype(np.float32),
                        dtype=tf.float32)
    ...
    def test_tile(self):
        ...
        x = tf.constant(np.random.randn(2, 3).astype(np.float32),
                        dtype=tf.float32)
    ...
    def test_expand_dims(self):
        ...
        x = tf.constant(np.random.randn(2, 3, 5).astype(np.float32),
                        dtype=tf.float32)
