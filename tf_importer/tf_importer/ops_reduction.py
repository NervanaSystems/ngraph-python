...
class OpsReduction(OpsBase):
    ...
    def _apply_reduction_op(self, reduction_op, tf_node, inputs):
        ...
        new_out_axes = [ng.make_axis(length=axis.length) for axis in result_op.axes]
    ...
    def Prod(self, tf_node, inputs):
        ...
        try:
            ...
            # get output axis
            out_axes = [ng.make_axis(input_tensor.axes[i].length)
